...
//20109072/1710394/2.50/5/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "ADPL44002AUJZ-3.3-R7" (originalName "ADPL44002AUJZ-3.3-R7")
	...
	(compDef "ADPL44002AUJZ-3.3-R7" (originalName "ADPL44002AUJZ-3.3-R7") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "4" (pinName "SENSE") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "VOUT") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ADPL44002AUJZ-3.3-R7"))
		...
		(attr "Mouser Part Number" "584-PL44002AUJZ33R7")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Analog-Devices/ADPL44002AUJZ-3.3-R7?qs=%252BXxaIXUDbq3bLG2Aqffs8Q%3D%3D")
		(attr "Manufacturer_Name" "Analog Devices")
		(attr "Manufacturer_Part_Number" "ADPL44002AUJZ-3.3-R7")
		(attr "Description" "40V, 200mA, Low Noise, CMOS LDO Linear Regulator")
		(attr "<Hyperlink>" "https://www.analog.com/ADPL44002/datasheet")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "ADPL44002AUJZ-3.3-R7.stp")
